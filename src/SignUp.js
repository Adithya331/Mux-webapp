  ...
  return (
    <main >        
        ...
        <div class="h-screen md:flex">
			<div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-blue-900 i justify-around items-center hidden">
				<div>
        ...
        <div class="flex md:w-1/2 justify-center py-5 items-center bg-white" id='boxcontain'>
			<form class="bg-white">
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
						...
						<path fill-rule="evenodd"
							...
							<button type="submit" class="block w-full bg-blue-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2" onClick={onSubmit}>Sign Up</button>
				...
				<span class="text-sm ml-2 text-blue-900 hover:text-black-500 cursor-pointer font-semibold mb-2">Already have an account ?<NavLink to="/login" >Sign in</NavLink></span>                     
		</form>
	</div>
