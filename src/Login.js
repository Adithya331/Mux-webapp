...
function Login() {
	...
	return (
		...
		<div
			class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-blue-900 i justify-around items-center hidden">
			<div>
				...
				<p class="text-sm font-normal text-gray-600 mb-7">Welcome Back</p>
						...
						<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
							...
							<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
								...
								<button type="submit" class="block w-full bg-blue-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2" onClick={onLogin}>Login</button>
								...
								<span class="text-sm ml-2 text-blue-900 hover:text-black-500 cursor-pointer font-semibold mb-2">                            
									No account yet? {' '}
									<NavLink to="/signup">
										Sign up
									</NavLink>
